...
<nav class="collapse navbar-collapse navbar-wire bs-navbar-collapse" role="navigation">
    <ul class="nav navbar-nav">
        ...
        <li class="dropdown <%= activeContent ? "active" : "" %>" onmouseover="hover(this);" onmouseout="out(this);">
        ...
        <li class="<%= activeModule ? "active" : "" %>"><a href="<%= request.getContextPath()%>/cris/administrator/index.htm"><fmt:message key="jsp.layout.navbar-admin.cris"/></a></li>
            <% }%>
        <li class="dropdown <%= activeAccess ? "active" : "" %>" onmouseover="hover(this);" onmouseout="out(this);">
        ...
        <li class="dropdown <%= activeSettings ? "active" : "" %>" onmouseover="hover(this);" onmouseout="out(this);">
